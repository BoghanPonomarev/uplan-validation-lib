...
public class EntityValidationFailedResponseClientHandlerImpl<T extends EntityValidationFailDto> implements EntityValidationFailedResponseClientHandler<T> {
